  ...
  <div class="component__wrap" v-if="pageData.campData">
		...
		<div class="content__wrap" v-for="(data, index) in pageData.campData" v-bind:key="index">
			<div class="cell cell__75">
				<div class="material__wrap --small --sharp__corners date__wrapper">
					<span class="boys">Boys: {{data.acf.trac_page_content.date_information.boys.boys_start_date}} - {{data.acf.trac_page_content.date_information.boys.boys_end_date}} </span>
                    |
                    <span class="girls">Girls: {{data.acf.trac_page_content.date_information.girls.start_date}} - {{data.acf.trac_page_content.date_information.girls.end_date}} </span>
				</div>
			</div>
		</div>		  
	  </div>	  
	  <div class="row">
		<div class="content__wrap" v-for="(data, index) in pageData.campData" v-bind:key="index">
			...
			<div class="cell cell__50">
				<article class="header__yellow paragraph__white paragraph__bold padding__left__5 padding__right__5" v-html="data.acf.trac_page_content.content_block"></article>
			</div>
		</div>		  
	</div>	 
	...
	<div class="row margin__bottom__5">
		<div class="content__wrap" v-for="(data, index) in pageData.campData" v-bind:key="index">
			<div class="cell cell__50">
				<article class="header__yellow paragraph__white paragraph__bold padding__left__5 padding__right__5" v-html="data.acf.trac_page_content.content_block_b"></article>
			</div>
		</div>
	</div>
	<div class="row margin__bottom__10">
		<div class="content__wrap --flex__end" v-for="(data, index) in pageData.campData" v-bind:key="index">
			<div class="cell cell__50">
				<article class="header__yellow paragraph__white paragraph__bold padding__left__5 padding__right__5" v-html="data.acf.trac_page_content.content_block_c"></article>
			</div>
		</div>
	</div>
	<div class="row margin__bottom__10">
		<div class="content__wrap" v-for="(data, index) in pageData.campData" v-bind:key="index">
			<div class="cell cell__50">
				<article class="header__yellow paragraph__white paragraph__bold padding__left__5 padding__right__5" v-html="data.acf.trac_page_content.content_block_d"></article>
			</div>
		</div>
	</div>
	<div class="row margin__bottom__10">
		<div class="content__wrap --flex__end" v-for="(data, index) in pageData.campData" v-bind:key="index">
			<div class="cell cell__50">
				<article class="header__yellow paragraph__white paragraph__bold padding__left__5 padding__right__5" v-html="data.acf.trac_page_content.content_block_e"></article>
			</div>
		</div>
	</div>    
...
export default {
	async asyncData({ store, params }) {
		let [camp, camps] = await Promise.all([
			axios.get(`${store.state.wordpressAPI}/wp/v2/lfh_camps/35`),
